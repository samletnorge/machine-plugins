...
def test_agent_run_request_valid():
    from server_support.models import AgentRunRequest
...
def test_agent_generate_request_with_schema():
    from server_support.models import AgentGenerateRequest
...
def test_tool_execute_request():
    from server_support.models import ToolExecuteRequest
...
def test_workflow_start_request():
    from server_support.models import WorkflowStartRequest
...
def test_thread_create_request():
    from server_support.models import ThreadCreateRequest
...
def test_message_create_request():
    from server_support.models import MessageCreateRequest
...
def test_agent_info_response():
    from server_support.models import AgentInfoResponse
...
def test_error_response():
    from server_support.models import ErrorResponse
