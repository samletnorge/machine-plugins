...
def test_implements_agent_runner():
    ...
    from machine_core.plugins.agent_runtime_pydantic.runtime import PydanticAgentRunner
...
async def test_run_calls_model_resolver():
    ...
    with patch(
        "machine_core.plugins.agent_runtime_pydantic.runtime.Agent"
    ) as MockAgent:
...
def test_tool_definition_to_pydantic():
    ...
    from machine_core.plugins.agent_runtime_pydantic.converters import (
